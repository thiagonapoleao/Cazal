...
<body style="background: linear-gradient(to bottom,  #00c6ff, #0072ff); background-repeat: no-repeat; background-attachment: fixed; background-size: 100% 100%; ">
    <header>
        ...
        <nav class="navbar fixed-top navbar-expand navbar-light" style="background: linear-gradient(to bottom,  #00c6ff, #0072ff)">
            <a class="nav-link" data-toggle="modal" data-target="#viradatacontabil" href="" style="color: black; font-size: 20px;">Cazal</a>
            <div id="collapse-navbar" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="../cadastro_cliente/cadastro.php">Cadastro de Cliente - Layout 1</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="../cadastro_cliente2/cadastro.php">Cadastro de Cliente - Layout 2</a>
                            <div class="dropdown-divider"></div>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="procedimentos.php">Procedimentos - Layout 1</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="procedimentos.php">Procedimentos - Layout 2</a>
                            <div class="dropdown-divider"></div>
                        </div>
                    </li>
                </ul>
    ...
    <div id="interface" style="background: linear-gradient(to top,#004e92, #000428, #000000); background-repeat: no-repeat; background-attachment: fixed; background-size: 100% 100%; margin-top: 80px;color: blanchedalmond">
            ...
            <form action="edit.php" method="post" class="needs-validation" novalidate>
                <div align="center">
                    <div class="form-row">
                        ...
                        <div class="col-sm-2 mb-1">
                            <br>
                            <button type="submit" id="submit" name="Import" class="btn btn-primary" style="height:50px;width:150px">Cadastrar</button>
        ...
        <div align="center" style="margin-top: 10px;">
            <div class="border border-danger" style="background-color: white; color: black; width: 95%; border-radius: 20px; font-size: 14px; min-height: 350px;">
                <div class="container">
                    <from>
