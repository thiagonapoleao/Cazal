...
$sql_count = "SELECT count(cpf) FROM cadastro_pacientes where cpf='$cpf'";
...
if ($total == 0) {
    ...
    window.alert('CPF não cadastrada, tente novamente!');
    window.location.href='procedimentos.php';
    </script>");
} else {

    // sql_count para contar o total de registros
    $sql_count_proc = "SELECT count(id) FROM procedimentos_realizados where cpf='$cpf'";
    // conta o toal de registros
    ...
    $sql_arry = "SELECT id, cpf, nome, tipo_adendimento, tipo_consulta, tipo_procedimento, encaminhamento, obs, tipo_pagamento, valor, dt_procedimento FROM procedimentos_realizados where cpf = '$cpf'";
    ...
    // SQL para selecionar os registros
    $sql_arry_pacientes = "SELECT id, cpf, nome, dtnascimento, endereco, numero, bairro, cep, cidade, telefone, celular, dtcadastro FROM cadastro_pacientes where cpf= '$cpf' ";
    // seleciona os registros
    $stmt_array_pacientes  = $PDO->prepare($sql_arry_pacientes);
    $stmt_array_pacientes->execute();
}
?>
            ...
            <form action="add.php" method="post" class="needs-validation" id="formSearch" novalidate>
                <div align="center">
                    <div class="row justify-content-md-center">
                        <?php while ($pacientes = $stmt_array_pacientes->fetch(PDO::FETCH_ASSOC)) : ?>
                            <div class="col-sm-3 mb-1">
                                <label for="validationServer01">CPF</label>
                                <input type="text" name="cpf" id="cpf" class="form-control" value=" <?php echo $pacientes['cpf'] ?>">
                            </div>
                            <div class="col-sm-5 mb-1">
                                <label for="validationServer02">Nome</label>
                                <input type="text" name="nome" id="nome" class="form-control" value=" <?php echo $pacientes['nome'] ?>">
                            </div>
                    ...
                    <div class="row justify-content-md-center">
                        <div class="col-sm-3 mb-1">
                            ...
                            <input list="atendimentos" name="atendimento" id="atendimento" class="form-control" required autofocus>
                        ...
                        <div class="col-sm-3 mb-1">
                            ...
                            <input list="consultas" name="consulta" id="consulta" class="form-control" required>
                        ...
                        <div class="col-sm-5 mb-1">
                            ...
                            <input list="procedimentos" name="procedimento" id="procedimento" class="form-control" required>
                        ...
                        <div class="col-sm-5 mb-1">
                            ...
                            <input list="encaminhamentos" name="encaminhamento" id="encaminhamento" class="form-control" required>
                        ...
                        <div class="col-sm-2 mb-1">
                            ...
                            <input list="pagamentos" name="pagamento" id="pagamento" class="form-control" required>
