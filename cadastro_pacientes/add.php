...
if (empty($cpf) || empty($nome)) {
	echo "Erro ao Cadastrar pacientes";
} else {
	...
	$sql = "INSERT INTO cadastro_pacientes(cpf, nome, dtnascimento, endereco, numero, bairro, cidade, cep, telefone, celular, dtcadastro ) VALUES(:cpf, :nome, :dtnascimento, :endereco, :numero, :bairro, :cidade, :cep, :telefone, :celular, :dtcadastro)";
	...
	<header>
		<div class="container" id="interface" style="background-image:  url('../img/logo-pagina-inicial3.jpg'); background-repeat: no-repeat; background-attachment: fixed; background-size: 100% 100%; min-height: 500px; margin-top: 60px" align="center">
			<div class="alert alert-danger" role="alert">
				<h2 style="color: red">Erro ao cadastrar pacientes!</h2>
